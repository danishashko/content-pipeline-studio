      ...
      >
        <div
          style={{
            ...
            height: "32px",
            borderRadius: "8px",
            background: "linear-gradient(135deg, var(--th-accent) 0%, #6366f1 100%)",
            display: "flex",
            alignItems: "center",
        ...
        {!collapsed && (
          <div>
            <div style={{ fontSize: "13px", fontWeight: 600, color: "var(--th-text)", lineHeight: 1.2 }}>
              Content Pipeline
            </div>
            <div style={{ fontSize: "11px", color: "var(--th-text-muted)", lineHeight: 1.2, marginTop: "2px" }}>
              Studio
            </div>
          </div>
        )}
          ...
          return (
            <Link
              ...
              style={{
                ...
                borderRadius: "8px",
                textDecoration: "none",
                color: active ? "var(--th-text-accent)" : "var(--th-text-secondary)",
              ...
              onMouseEnter={e => {
                if (!active) {
                  (e.currentTarget as HTMLAnchorElement).style.background = "var(--th-sidebar-hover)";
              ...
              onMouseLeave={e => {
                if (!active) {
                  ...
                  (e.currentTarget as HTMLAnchorElement).style.color = "var(--th-text-secondary)";
                }
              }}
            >
              {active && (
