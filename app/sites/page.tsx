      ...
      .then((data) => {
        ...
        setSites(
          raw.map((s: Record<string, unknown>) => ({
            ...
            companyName:
              ((s.config as Record<string, unknown>)?.companyName as string) ??
              (s.name as string) ??
              "",
            tagline:
              ((s.config as Record<string, unknown>)?.tagline as string) ?? "",
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "28px" }}>
      ...
      >
        ...
        <Link
          ...
          onMouseEnter={(e) =>
            (e.currentTarget.style.background = "var(--th-accent-hover)")
          }
          onMouseLeave={(e) =>
            (e.currentTarget.style.background = "var(--th-accent)")
          }
        >
          <PlusIcon />
          Add Site
        ...
        >
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="card" style={{ padding: "24px" }}>
              ...
              <div
                className="skeleton"
                style={{ width: "100%", height: "1px", marginBottom: "16px" }}
              />
